<script lang="ts">
	...
	let selected_food: Food;
	let selected_ftier: Food;
 
      let MAX_CHAR_WEIGHT:number|null = null;
      let CURR_CHAR_WEIGHT:number|null = null;
      let BATCHES = 1;
        ...
        <div class="column">
            ...
            <!-- {#if ($in_use)}
                  <main class="container">
		            <svelte:component this={goto("/process", true)}/>
                  </main>
            {/if} -->
